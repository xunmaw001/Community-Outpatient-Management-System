<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的社区门诊管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">医生编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yishengbianhao" class="input" type="text" placeholder="医生编号">
			   </div>
			 </div> -->
			<el-form-item label="医生编号" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.yishengbianhao" autocomplete="off" placeholder="医生编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
