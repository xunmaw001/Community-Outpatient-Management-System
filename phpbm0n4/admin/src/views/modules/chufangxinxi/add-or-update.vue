<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品规格" prop="yaopinguige">
          <el-input v-model="ruleForm.yaopinguige" 
              placeholder="药品规格" clearable  :readonly="ro.yaopinguige"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品规格" prop="yaopinguige">
              <el-input v-model="ruleForm.yaopinguige" 
                placeholder="药品规格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服药次数" prop="fuyaocishu">
          <el-input v-model="ruleForm.fuyaocishu" 
              placeholder="服药次数" clearable  :readonly="ro.fuyaocishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服药次数" prop="fuyaocishu">
              <el-input v-model="ruleForm.fuyaocishu" 
                placeholder="服药次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服药剂量" prop="fuyaojiliang">
          <el-input v-model="ruleForm.fuyaojiliang" 
              placeholder="服药剂量" clearable  :readonly="ro.fuyaojiliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服药剂量" prop="fuyaojiliang">
              <el-input v-model="ruleForm.fuyaojiliang" 
                placeholder="服药剂量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
