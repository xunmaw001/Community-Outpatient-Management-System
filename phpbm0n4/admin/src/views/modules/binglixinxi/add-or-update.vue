    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主诉病症" prop="zhusubingzheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主诉病症"
                  v-model="ruleForm.zhusubingzheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhusubingzheng" label="主诉病症" prop="zhusubingzheng">
                    <span>{{ruleForm.zhusubingzheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
